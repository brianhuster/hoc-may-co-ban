# Làm quen với Python và Scikit-learn cho mô hình hồi quy
...
Trong bốn bài học này, bạn sẽ khám phá cách xây dựng mô hình hồi quy. Nhưng trước đó, hãy đảm bảo bạn có sẵn các công cụ phù hợp để bắt đầu!
...
1. **Cài Python**. Đảm bảo rằng [Python](https://www.python.org/downloads/) đã được cài đặt trên máy tính của bạn. Bạn sẽ sử dụng Python cho nhiều tác vụ khoa học dữ liệu và học máy. Hầu hết các hệ thống máy tính đều đã cài đặt Python. Ngoài ra còn có [Gói mã hóa Python](https://code.visualstudio.com/learn/educators/installers?WT.mc_id=academic-77952-leestott) để dễ dàng thiết lập cho một số người dùng.

   Đôi khi, bạn có thể cần các phiên bản Python khác nhau cho các dự án khác nhau. Khi đó, bạn có thể [virtual environment](https://docs.python.org/3/library/venv.html).
